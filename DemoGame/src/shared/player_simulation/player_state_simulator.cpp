...
bool PlayerStateSimulator::UnsubscribeFromOnShotPerformed( const Common::Delegate<>::SubscriptionHandler& handler )
{
	return _shootingController.OnShotPerformed.DeleteSubscriber( handler );
}
