...
void RemotePlayerControllerSystem::Tick( ECS::EntityContainer& entityContainer, float32 elapsedTime ) const
{
	std::vector< GameEntity > remotePlayerEntities =
	    entityContainer.GetEntitiesOfType< RemotePlayerControllerComponent >();
