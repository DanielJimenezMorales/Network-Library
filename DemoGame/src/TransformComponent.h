...
/// <summary>
/// <para>Rotations will be represented using one float32 which will represent the rotation angles. This rotation is anti-clockwise. A rotation angle of 0 degrees
