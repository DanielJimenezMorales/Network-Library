...
private:
	...
	/// </summary>
	void TickSweepAndPrune(EntityContainer& entityContainer) const;

	/// <summary>
	/// <para>Sort all potential colliders using X coordinate from left to right in order to be able to apply future optimizations.</para>
	/// </summary>
	...
	/// <summary>
	/// <para>This method applies SAT collision detection algorithm between two shapes. For more info see <see href="https://dyn4j.org/2010/01/sat/">this link</see></para>
	/// <para>NOTE: In case of collision, this method resturns true and mtv contains the magnitude and normalized direction of the same minimum translation vector (useful for collision response)</para>
	/// </summary>
	bool AreTwoShapesCollidingUsingSAT(const Collider2DComponent& collider1, const TransformComponent& transform1, const Collider2DComponent& collider2, const TransformComponent& transform2, MinimumTranslationVector& outMtv) const;

	/// <summary>
	/// <para>Returns all axes neccessary for performing a SAT collision detection. Supported collisions are are:</para>
	/// <para>1) 2D convex shape VS 2D convex shape</para>
	/// <para>2) 2D convex shape VS 2D circle (or viceversa)</para>
	/// <para>3) 2D circle VS 2D circle</para>
	/// </summary>
	...
	/// <summary>
	/// <para>Calculates the overlap magnitude from the result of projecting both collision objects over an axis.</para>
	/// <para>NOTE: If projections don't overlap, this method returns 0, otherwise the overlap magnitude</para>
	/// </summary>
	/// <returns></returns>
	...
	/// <summary>
	/// <para>Applies a collision response based on the mtv in order to separate both colliding shapes. This method supports the following types of collision responses:</para>
	/// <para>1) Dynamic collider VS Dynamic collider</para>
	/// <para>2) Dynamic collider VS Static collider (or viceversa)</para>
	/// </summary>
