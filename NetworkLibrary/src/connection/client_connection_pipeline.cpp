	...
	namespace Connection
	{
		                                                                            ...
		                                                                            uint64 data_prefix )
		{
			...
			std::unique_ptr< Message > message =
			    message_factory.LendMessage( MessageType::ConnectionChallengeResponse );
			if ( message == nullptr )
			{
				LOG_ERROR(
		...
		static void ProcessConnectionChallenge( PendingConnection& pending_connection,
		                                        const ConnectionChallengeMessage& message,
		...
		static void ProcessConnectionDenied( PendingConnection& pending_connection,
		                                     const ConnectionDeniedMessage& message )
		{
		                            ...
		                            MessageFactory& message_factory )
		{
			...
			switch ( type )
			{
				...
				case MessageType::ConnectionDenied:
					...
					break;
				default:
					LOG_ERROR( "ClientConnectionPipeline.%s Incoming message not supported. Type: %u",
		...
		static void AddConnectionRequestMessage( PendingConnection& pending_connection,
		                                         MessageFactory& message_factory )
		{
