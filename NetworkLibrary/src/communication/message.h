...
namespace NetLib
{
	class Message
	{
		public:
			...
			void SetHeaderPacketSequenceNumber( uint16 packetSequenceNumber )
			{
				_header.messageSequenceNumber = packetSequenceNumber;
			}
		...
		protected:
			Message( MessageType messageType )
			    : _header( messageType, 0, false, false ) {};
	...
	class ConnectionRequestMessage : public Message
	{
		public:
			ConnectionRequestMessage()
			    : clientSalt( 0 )
			    , Message( MessageType::ConnectionRequest )
			{
			}
	...
	class ConnectionChallengeResponseMessage : public Message
	{
		public:
			ConnectionChallengeResponseMessage()
			    : prefix( 0 )
			    , Message( MessageType::ConnectionChallengeResponse )
			{
			}
	...
	class ConnectionAcceptedMessage : public Message
	{
		public:
			ConnectionAcceptedMessage()
			    : prefix( 0 )
			    , clientIndexAssigned( 0 )
			    , Message( MessageType::ConnectionAccepted )
			{
			}
	...
	class ConnectionDeniedMessage : public Message
	{
		public:
			ConnectionDeniedMessage()
			    : Message( MessageType::ConnectionDenied )
			    , reason( 0 )
			{
			}
	...
	class TimeRequestMessage : public Message
	{
		public:
			TimeRequestMessage()
			    : remoteTime( 0 )
			    , Message( MessageType::TimeRequest )
			{
			}
	...
	class TimeResponseMessage : public Message
	{
		public:
			TimeResponseMessage()
			    : remoteTime( 0 )
			    , serverTime( 0 )
			    , Message( MessageType::TimeResponse )
			{
			}
	...
	class ReplicationMessage : public Message
	{
		public:
			ReplicationMessage()
			    ...
			    , dataSize( 0 )
			    , data( nullptr )
			    , Message( MessageType::Replication )
			{
			}
