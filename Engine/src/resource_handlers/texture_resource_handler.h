...
namespace Engine
{
	...
	/// <summary>
	/// This class is a centralized and safe storage for texture resources. It contains an internal cache system in
	/// order to reduce texture loading the same texture multiple times.
	/// </summary>
	class TextureResourceHandler
	{
		public:
			...
			/// <summary>
			/// Loads a texture and returns an associated handler. If the texture is loaded for the very first time,
			/// it'll be loaded saved in a cache, otherwise it'll be reused.
			/// </summary>
